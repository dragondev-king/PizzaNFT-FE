...
export function Common() { 
    ...
    return { account, profileImg, name, profileUrl, email, coverImg, facebook, bio, top_owners, token_ids, total, bids, historys, hots, bidstatus, NFTcontract, AUCTIONcontract, mintPrice, FTcontract, followInfos, searchText }
}
