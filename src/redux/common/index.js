...
export function Common() { 
    ...
    return { account, profileImg, name, profileUrl, email, coverImg, facebook, top_owners, token_ids, bids, historys, hots, bidstatus, NFTcontract, AUCTIONcontract, mintPrice, FTcontract, followInfos, searchText }
}
