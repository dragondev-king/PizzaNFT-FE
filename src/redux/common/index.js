...
export function Common() { 
    const { profileImg, name, profileUrl, email, coverImg, facebook, bio } = useSelector( (state) => state.data[0] ? state.data[0] : "");
    ...
    return { account, profileImg, name, profileUrl, email, coverImg, facebook, bio, top_owners, token_ids, page, page_size, total, bids, historys, hots, bidstatus, NFTcontract, AUCTIONcontract, mintPrice, FTcontract, followInfos, searchText }
}
